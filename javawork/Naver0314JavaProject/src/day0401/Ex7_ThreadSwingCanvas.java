...
public class Ex7_ThreadSwingCanvas extends JFrame implements ActionListener {
	...
	public Ex7_ThreadSwingCanvas(String title) {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Ex7_ThreadSwingCanvas a=new Ex7_ThreadSwingCanvas("스레드예제");
