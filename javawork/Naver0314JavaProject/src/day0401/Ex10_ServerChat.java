...
public class Ex10_ServerChat extends JFrame implements Runnable{
	JTextArea area;
	Vector<ClientMember> list=new Vector<Ex10_ServerChat.ClientMember>();
	ServerSocket serverSocket;
	
	public Ex10_ServerChat(String title) {
	...
	class ClientMember extends Thread
	{
		...
		public void run() {
			...
			//클라이언트가 보내는 메세지를 언제든지 읽어서 보내줄수 있도록 한다
			while(true)
			{
				try {
	...
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Ex10_ServerChat a=new Ex10_ServerChat("채팅서버");
